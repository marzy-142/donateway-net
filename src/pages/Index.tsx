          ...
          <div className="grid gap-8 md:grid-cols-2 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 md:text-xl/relaxed">
                ...
                <span className="text-bloodlink-red font-semibold">
            ...
            <div className="flex justify-center">
              <img
                src="/lovable-uploads/BloodDonation2.jpg"
                alt="Blood donation"
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow">
              ...
              <p className="text-gray-600 mt-2">
                Sign up and complete your donor profile with your blood type and
                availability.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow">
              ...
              <p className="text-gray-600 mt-2">
                Our system matches donors with compatible recipients in need of
                blood.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow">
              ...
              <p className="text-gray-600 mt-2">
                Connect with hospitals, schedule donations, and make a
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="bg-white p-6 rounded-lg shadow text-center">
              <div className="text-4xl font-bold text-bloodlink-red mb-2">
                1 Unit
              </div>
      ...
      <section className="py-16 bg-gradient-to-r from-bloodlink-red to-red-600 text-white">
        <div className="container px-4 md:px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join thousands of donors who are saving lives every day through the
            BloodLink network.
          </p>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/donors" className="text-gray-400 hover:text-white">
                    Find Donors
                  </Link>
                </li>
              </ul>
