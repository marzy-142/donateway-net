            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card>
                <CardHeader className="bg-gradient-to-r from-bloodlink-pink to-bloodlink-darkpink">
                  ...
                  <CardDescription>
                    Manage donor-recipient matches
                  </CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                  <p className="mb-4">
                    Review and approve matches between donors and recipients.
                  </p>
                  <Link to="/matches">
              ...
              <Card>
                ...
                <CardContent className="pt-6">
                  <p className="mb-4">
                    Add new hospitals and manage existing hospital information.
                  </p>
                  <Button
                    className="w-full"
                    variant="outline"
              ...
              <Card>
                ...
                <CardContent className="pt-6">
                  <p className="mb-4">
                    View detailed analytics and statistics about the blood
                    donation system.
                  </p>
                  <Button
                    className="w-full"
              ...
              <Card>
                ...
                <CardContent className="pt-6">
                  <p className="mb-4">
                    Schedule and manage blood donation drives and events.
                  </p>
                  <Button
                    className="w-full"
                    variant="outline"
              ...
              <Card>
                ...
                <CardContent className="pt-6">
                  <p className="mb-4">
                    View and respond to critical blood shortage alerts and
                    system issues.
                  </p>
                  <Button
                    className="w-full"
